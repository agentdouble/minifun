...
const MAP = {
  ...
  obstacles: [
    ...
    { id: "tower-north-lower-mid", position: { x: 0, y: 0.45, z: -4.1 }, size: { x: 1.6, y: 0.9, z: 0.6 } },
    { id: "tower-north-lower-right", position: { x: 3, y: 0.45, z: -4.1 }, size: { x: 2.2, y: 0.9, z: 0.6 } },
    { id: "tower-north-upper-left", position: { x: -3, y: 2.1, z: -4.1 }, size: { x: 2.2, y: 0.8, z: 0.6 } },
    { id: "tower-north-upper-mid", position: { x: 0, y: 2.1, z: -4.1 }, size: { x: 1.6, y: 0.8, z: 0.6 } },
    { id: "tower-north-upper-right", position: { x: 3, y: 2.1, z: -4.1 }, size: { x: 2.2, y: 0.8, z: 0.6 } },

    { id: "tower-south-lower-left", position: { x: -3.1, y: 0.45, z: 4.1 }, size: { x: 2, y: 0.9, z: 0.6 } },
    { id: "tower-south-lower-right", position: { x: 3.1, y: 0.45, z: 4.1 }, size: { x: 2, y: 0.9, z: 0.6 } },
    { id: "tower-south-lower-column-left", position: { x: -0.95, y: 0.45, z: 4.1 }, size: { x: 0.3, y: 0.9, z: 0.6 } },
    { id: "tower-south-lower-column-right", position: { x: 0.95, y: 0.45, z: 4.1 }, size: { x: 0.3, y: 0.9, z: 0.6 } },
    { id: "tower-south-upper-left", position: { x: -3.1, y: 2.1, z: 4.1 }, size: { x: 2, y: 0.8, z: 0.6 } },
    { id: "tower-south-upper-right", position: { x: 3.1, y: 2.1, z: 4.1 }, size: { x: 2, y: 0.8, z: 0.6 } },
    { id: "tower-south-upper-column-left", position: { x: -0.95, y: 2.1, z: 4.1 }, size: { x: 0.3, y: 0.8, z: 0.6 } },
    { id: "tower-south-upper-column-right", position: { x: 0.95, y: 2.1, z: 4.1 }, size: { x: 0.3, y: 0.8, z: 0.6 } },

    { id: "tower-east-lower-north", position: { x: 4.1, y: 0.45, z: -3 }, size: { x: 0.6, y: 0.9, z: 2.2 } },
    { id: "tower-east-lower-mid", position: { x: 4.1, y: 0.45, z: 0 }, size: { x: 0.6, y: 0.9, z: 1.6 } },
    { id: "tower-east-lower-south", position: { x: 4.1, y: 0.45, z: 3 }, size: { x: 0.6, y: 0.9, z: 2.2 } },
    { id: "tower-east-upper-north", position: { x: 4.1, y: 2.1, z: -3 }, size: { x: 0.6, y: 0.8, z: 2.2 } },
    { id: "tower-east-upper-mid", position: { x: 4.1, y: 2.1, z: 0 }, size: { x: 0.6, y: 0.8, z: 1.6 } },
    { id: "tower-east-upper-south", position: { x: 4.1, y: 2.1, z: 3 }, size: { x: 0.6, y: 0.8, z: 2.2 } },

    { id: "tower-west-lower-north", position: { x: -4.1, y: 0.45, z: -3 }, size: { x: 0.6, y: 0.9, z: 2.2 } },
    { id: "tower-west-lower-mid", position: { x: -4.1, y: 0.45, z: 0 }, size: { x: 0.6, y: 0.9, z: 1.6 } },
    { id: "tower-west-lower-south", position: { x: -4.1, y: 0.45, z: 3 }, size: { x: 0.6, y: 0.9, z: 2.2 } },
    { id: "tower-west-upper-north", position: { x: -4.1, y: 2.1, z: -3 }, size: { x: 0.6, y: 0.8, z: 2.2 } },
    { id: "tower-west-upper-mid", position: { x: -4.1, y: 2.1, z: 0 }, size: { x: 0.6, y: 0.8, z: 1.6 } },
    { id: "tower-west-upper-south", position: { x: -4.1, y: 2.1, z: 3 }, size: { x: 0.6, y: 0.8, z: 2.2 } },

    { id: "tower-step-1", position: { x: 2.6, y: 0.21, z: 2.9 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-step-2", position: { x: 2.6, y: 0.63, z: 1.8 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-step-3", position: { x: 2.6, y: 1.05, z: 0.7 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-step-4", position: { x: 2.6, y: 1.47, z: -0.4 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-step-5", position: { x: 2.6, y: 1.89, z: -1.5 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-step-6", position: { x: 2.6, y: 2.31, z: -2.6 }, size: { x: 1.6, y: 0.42, z: 1.1 } },
    { id: "tower-stair-landing-1", position: { x: 2.6, y: 2.67, z: -3.4 }, size: { x: 1.8, y: 0.34, z: 0.8 } },
    { id: "tower-step-7", position: { x: 1.8, y: 3.09, z: -3.4 }, size: { x: 1.1, y: 0.42, z: 1.6 } },
    { id: "tower-step-8", position: { x: 0.7, y: 3.51, z: -3.4 }, size: { x: 1.1, y: 0.42, z: 1.6 } },
    { id: "tower-step-9", position: { x: -0.4, y: 3.93, z: -3.4 }, size: { x: 1.1, y: 0.42, z: 1.6 } },
    { id: "tower-step-10", position: { x: -1.5, y: 4.35, z: -3.4 }, size: { x: 1.1, y: 0.42, z: 1.6 } },
    { id: "tower-step-11", position: { x: -2.6, y: 4.6, z: -3.4 }, size: { x: 1.2, y: 0.3, z: 1.6 } },

    { id: "tower-top-north", position: { x: 0, y: 4.9, z: -3 }, size: { x: 7.6, y: 0.18, z: 1.6 } },
    { id: "tower-top-south", position: { x: 0, y: 4.9, z: 3 }, size: { x: 7.6, y: 0.18, z: 1.6 } },
    { id: "tower-top-west", position: { x: -3, y: 4.9, z: 0 }, size: { x: 1.6, y: 0.18, z: 4.4 } },
    { id: "tower-top-east", position: { x: 3, y: 4.9, z: 0 }, size: { x: 1.6, y: 0.18, z: 4.4 } },
